 ...
 * to not interact with liquids or ladders
 */
public class DryNonhangingXYZPlayer extends AbstractXYZPlayer {
  ...
  public DryNonhangingXYZPlayer(XYZAxisAlignedBB boundingBox, double posX, double posY, double posZ, double velX,
  ...
  public DryNonhangingXYZPlayer(double posX, double posY, double posZ, double velX, double velY, double velZ,
      float yaw) {
    super(posX, posY, posZ, velX, velY, velZ, yaw);
    init();
  }

  public DryNonhangingXYZPlayer() {
    super();
    init();
  }
  ...
  @Override
  public DryNonhangingXYZPlayer clone() {
    DryNonhangingXYZPlayer other = new DryNonhangingXYZPlayer(boundingBox.clone(), posX, posY, posZ, velX, velY, velZ,
        yaw, flagsIn.checkSneaking, flagsIn.checkStepping);
    copy(other, this);
    return other;
  }

  public static void copy(DryNonhangingXYZPlayer target, DryNonhangingXYZPlayer source) {
