...
public class StoneXYZPlayer extends AbstractXYZPlayer {
  ...
  public StoneXYZPlayer(XYZAxisAlignedBB boundingBox, double posX, double posY, double posZ, double velX, double velY,
      double velZ, float yaw, boolean checkSneaking, boolean checkStepping) {
  ...
  public StoneXYZPlayer clone() {
    return new StoneXYZPlayer(boundingBox.clone(), posX, posY, posZ, velX, velY, velZ, yaw, flagsIn.checkSneaking,
   ...
   * @param keySneak
   */
  public void step(final IXYZMoveEntityHandler<? super StoneXYZPlayer> moveEntityHandler, final float keyStrafe,
