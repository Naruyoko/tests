...
/**
 * A utility class for a world handling horizontal movement with given wall that
 * do not have any special effect.
 */
public class XZMoveEntityHandlerFromCollidableSimpleWall implements IXZMoveEntityHandler<AbstractXZPlayer> {
  ...
  public XZMoveEntityHandlerFromCollidableSimpleWall(IHorizontallyCollidable wall) { this.wall = wall; }
