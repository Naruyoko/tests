  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // String.format("startPosition=%f,%f,%f",player.posX,100.0,player.posZ)+System.lineSeparator()+
          ...
          + String.format("mouseMaxSafeMovement=%d", BeamSearchConcurrent.maximumMovementPerFrame)
          + System.lineSeparator() + String.format("tickLength=%d", searcher.getSolutionLength() + 20)
          + System.lineSeparator() + "rerecords=0" + System.lineSeparator() + "predictionRerecords=0"
          + System.lineSeparator() + "totalRerecords=0" + System.lineSeparator() + "fileFormatVersion=2"
          + System.lineSeparator() + "editorVersion=0.0.6" + System.lineSeparator() + "" + System.lineSeparator()
          + "!input" + System.lineSeparator() + "###|WASD_+^|Yaw,Pitch|Flags" + System.lineSeparator());
      for (int t = -1; t < searcher.getSolutionLength(); t++) {
        if (t >= 0) {
          BeamSearchConcurrent.moveCameraWithDivision(player, result.mouseMovements[t]);
          BeamSearchConcurrent.stepPlayer(player);
        }
