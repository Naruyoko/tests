...
/**
 * A utility class for a world handling horizontal movement with the wall made
 * of full blocks. The ground is assumed to be infinitely extending.
 */
public abstract class AbstractXZStoneWall implements IXZMoveEntityHandler<AbstractXZPlayer> {
  ...
  public SimulationFlagsOut moveEntity(AbstractXZPlayer player, double x, double z, SimulationFlagsIn flagsIn,
    ...
    List<XZAxisAlignedBB> collidingBoundingBoxes = getHorizontallyCollidingBoundingBoxes(
