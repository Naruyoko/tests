 ...
 * and wall that do not have any special effect.
 */
public class XZMoveEntityHandlerFromCollidableSimpleGroundAndWall implements IXZMoveEntityHandler<AbstractXZPlayer> {
  ...
  public XZMoveEntityHandlerFromCollidableSimpleGroundAndWall(IHorizontallyCollidable ground,
      IHorizontallyCollidable wall) {
    this.ground = ground;
    this.wall = wall;
  }
  ...
  public SimulationFlagsOut moveEntity(AbstractXZPlayer player, double x, double z, SimulationFlagsIn flagsIn,
    ...
    List<XZAxisAlignedBB> collidingBoundingBoxes = wall.getHorizontallyCollidingBoundingBoxes(
    ...
    flagsOut.isCollidedVertically = ground.hasAnyHorizontallyCollidingBoundingBoxes(
        XZAxisAlignedBB.copyAddCoord(workingBoundingBox, player.boundingBox, xNoBlock, zNoBlock));
