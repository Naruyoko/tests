...
public class StoneXZPlayer extends AbstractXZPlayer {
  ...
  public StoneXZPlayer(XZAxisAlignedBB boundingBox,double posX,double posZ,double velX,double velZ,float yaw,boolean checkSneaking,boolean checkStepping) {
  ...
  public StoneXZPlayer clone() {
    return new StoneXZPlayer(boundingBox.clone(), posX, posZ, velX, velZ, yaw, flagsIn.checkSneaking, flagsIn.checkStepping);
  }
   ...
   * @param keySneak
   */
  public void step(final IXZMoveEntityHandler<? super StoneXZPlayer> movementHandler,final float keyStrafe,final float keyForward,final boolean keySprint,final boolean keySneak) {
    ...
    movementHandler.moveEntity(this, velX, velZ, flagsIn, flagsOut); // {net.minecraft.entity.Entity.moveEntity(double, double, double)}
