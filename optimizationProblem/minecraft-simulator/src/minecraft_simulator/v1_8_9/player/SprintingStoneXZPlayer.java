...
public class SprintingStoneXZPlayer extends AbstractXZPlayer {
  ...
  public SprintingStoneXZPlayer(XZAxisAlignedBB boundingBox, double posX, double posZ, double velX, double velZ,
      float yaw) {
  ...
  /**
   * Simulate 1 tick of movement on a normal flat surface with walls while
   * sprinting See {net.minecraft.entity.EntityLivingBase.onLivingUpdate()} See
   ...
   */
  public void step(final IXZMoveEntityHandler<? super SprintingStoneXZPlayer> world,
      final float movementInputMoveStrafe, final float movementInputMoveForward) {
